...
export default function EnhancedTable({props: PlanoDeContas}) {
...
//   const [planoDeContas, setPlanoDeContas] = React.useState(new PlanoDeContas());
          ...
          >
            ...
            <TableBody>
              ...
              {stableSort(rows, getComparator(order, orderBy))
                ...
                .map((props, index) => {
                  const isItemSelected = isSelected(props.name);
                  const labelId = `enhanced-table-checkbox-${index}`;

                  return (
                    <TableRow
                      hover
                      onClick={(event) => handleClick(event, props.name)}
                      role="checkbox"
